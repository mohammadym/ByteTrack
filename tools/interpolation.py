...
if __name__ == '__main__':
    data_root = '/content/ByteTrack/datasets/mot/test'
    txt_path = '/content/ByteTrack/YOLOX_outputs/yolox_x_mix_det/track_results'
    save_path = '/content/ByteTrack/YOLOX_outputs/yolox_x_mix_det/track_results_dti'
